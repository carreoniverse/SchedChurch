...
router.get('/', (req, res) => {
    res.render('guestwithsession/baptismal/views/baptismalreservation',{user: req.session.user});
});


router.get('/listofrequirements', (req, res) => {
    res.render('guestwithsession/baptismal/views/listofrequirements');
});

router.get('/listofsponsors', (req, res) => {
    res.render('guestwithsession/baptismal/views/listofsponsors');
});
...
router.post('/listofsponsors', (req, res) => {
    var queryString3 = `INSERT INTO tbl_sponsors(
        \`int_sponsorid\`,
        \`varchar_sposorlastname\`,
        \`varchar_sponsorfirstname\`,
        \`varchar_sponsormiddlename\`) 
    ...
    // console.log(req.session.sponsor)
    // res.redirect('/guestwithsession/baptismal/listofrequirements');
});
